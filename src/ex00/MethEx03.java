 ...
 * 7. static 메서드 내부에서는 heap에 있는 데이터를 찾을 수 없다.
 */

public class MethEx03 { // heap에 보관하는 방법(return보관법이 아니라)
    ...
    public static void main(String[] args) {
        ...
        System.out.println("start실행전sum:" + m.sum);
        m.start(); // 클래스명 생략 가능(같은 클래스에 있기 때문에!!)
        System.out.println("start실행후sum:" + m.sum);
    }
}