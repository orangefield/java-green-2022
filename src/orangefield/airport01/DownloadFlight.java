...
import orangefield.airport01.FlightDto.Response.Body.Items.Item;

public class DownloadFlight {
    // 특정 날짜에 특정 출발지에서 특정 목적지로 도착하는 항공편 정보 가져오는 메서드
    // DownloadFlight.getFlightList("20220126", "제주", "김해");
    public static List<Item> getFlightList(String depPlandTime, String depAirportNm, String arrAirportNm) {
